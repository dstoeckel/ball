	...
	class BALL_EXPORT FragmentDB
	{
		public:
			...
			*/
			 ...
			 */
			class BALL_EXPORT NoFragmentNode : public Exception::GeneralException
			{
				public:
			...
			*/
			 ...
			 */
			class BALL_EXPORT NormalizeNamesProcessor : public UnaryProcessor<Fragment>
			{
			...
			*/
			class BALL_EXPORT BuildBondsProcessor : public UnaryProcessor<Fragment>
			{
				...
				protected:
					...
					*/
					...
					/**
					 * The list of connects between(!) fragments still to be examined
					 */
